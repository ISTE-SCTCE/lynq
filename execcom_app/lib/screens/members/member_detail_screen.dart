...
class _MemberDetailScreenState extends State<MemberDetailScreen> {
  ...
  Future<void> _loadUser() async {
    ...
    try {
      final data = await supabase.from('users').select().eq('id', widget.userId).single();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(_user?.name ?? 'Member', style: GoogleFonts.spaceGrotesk(fontWeight: FontWeight.bold))),
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            if (perms.canRemoveMembers)
                              _actionBtn(Icons.person_remove, 'Remove Member', _removeMember, isDestructive: true),
                          ],
                        ),
                      ],
                    ],
