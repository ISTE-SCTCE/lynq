                  ...
                  {editingId === item.id ? (
                    ...
                    >
                      <motion.div className="flex flex-col">
                        ...
                        <div
                          className="flex flex-wrap gap-x-1 text-xs font-medium text-neutral-400 dark:text-neutral-500"
                        >
                          <span className="sm:hidden">{item.method}</span>
                          ...
                          {item.description && (
                            <>
                              <span>•</span>
                              <span className="truncate max-w-[150px] sm:max-w-[200px]" title={item.description}>
                                {item.description}
                              </span>
                            </>
                          )}
                      ...
                      >
                        <motion.span
                          layout="position"
                          transition={layoutTransition}
                          className={`flex items-center ${item.type === 'Income' ? 'text-emerald-500 dark:text-emerald-400 font-bold' : 'text-red-500 dark:text-red-400 font-bold'}`}
                        >
                      ...
                      {isEditable ? (
                        <div className="flex items-center gap-3 justify-end">
                          <button
                            ...
                            className="text-neutral-400 transition-transform hover:text-black active:scale-125 dark:hover:text-white"
                          >
                          ...
                          {onDelete && (
                            <button
                              ...
                              className="text-red-400 transition-transform hover:text-red-600 active:scale-125 dark:text-red-500 dark:hover:text-red-400"
                            >
