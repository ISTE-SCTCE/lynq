                    ...
                    {cards.map((card) => {
                      ...
                      return (
                        <div
                          ...
                          className={`flex cursor-pointer items-center justify-between rounded-xl border p-3 transition-all sm:p-4 ${
                            isSelected
                    ...
                    {presets.map((amount) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex-1 rounded-lg border py-2 text-xs font-semibold transition-all sm:text-sm ${
                            isSelected
