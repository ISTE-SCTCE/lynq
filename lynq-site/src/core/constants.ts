...
// PostgreSQL ENUM (app_role) â€” always one of the 7 canonical values.
...
// unnecessary â€” a post literally containing "head" (e.g. "Overhead
...
export function appRoleFromString(s?: string): AppRole {
  ...
  switch (normalized) {
    ...
    default: return AppRole.member; // unknown value â€” safe default, never escalate
  }
}
