...
void main() {
  ...
  for (int i = 0; i < lines.length; i++) {
    ...
    if (!insertedAdminAllocations && line.contains('String _myForumNames = \\'\\'; // Combined forum names for header')) {
      out.add(line);
    ...
    if (!insertedDashboard && line.contains('const SizedBox(height: 48);') && lines[i-1].contains('const SizedBox(height: 48);')) {
      // Find the end of _buildDashboardTab
                  ...
                  children: [
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        color: Colors.white, // Setting the requested white background
